...
The library rejects malformed URL escapes and multipart boundaries, caps HTTP
headers and bodies, bounds decompression output, strips `Authorization` across
